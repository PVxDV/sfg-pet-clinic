...
import pvxdv.springfamework.sfgpetclinic.model.*;
import pvxdv.springfamework.sfgpetclinic.services.*;
...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        Specialty savedRadiolody = specialtyService.save(radiology);
        ...
        vet1.getSpecialities().add(savedRadiolody);
